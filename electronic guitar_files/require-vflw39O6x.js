...
var external_shim, k, monkey_check, monkey_check_line_ok_chrome, monkey_check_line_ok_firefox, monkey_check_mod, monkey_error_module, v, _ref;
...
monkey_error_module = null;

monkey_check_line_ok_chrome = (function(_this) {
...
monkey_check_line_ok_firefox = (function(_this) {
  return function(line) {
    var mod;
    if (line === "") {
      return true;
...
monkey_check_mod = (function(_this) {
  return function(mod) {
    if (mod === null) {
      return true;
    }
...
monkey_check = (function(_this) {
  return function() {
    var failed;
    failed = false;
    return function() {
      var line, lines, pre, res, stack, text, _i, _len;
      ...
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        ...
        if (res === false) {
          if (!(typeof Constants !== "undefined" && Constants !== null ? Constants.IS_PROD : void 0) && window.sessionStorage) {
            if (!failed) {
              text = "You used a prototype monkey-patch in the clean module " + monkey_error_module + "\n\n" + stack + "\n\n" + line + "\n\n||" + line.indexOf("/static/javascript/compiled") + "||";
